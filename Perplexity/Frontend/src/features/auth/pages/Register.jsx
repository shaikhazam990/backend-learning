...
export default function Register() {
  ...
  const strengthColor = ['', '#ef4444', '#f59e0b', '#20d9c0'][strength]
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-root::after {
          ...
          background: radial-gradient(circle, rgba(32,217,192,0.04) 0%, transparent 65%);
          pointer-events: none;
        }
        ...
        .auth-logo-text { font-family: 'Syne', sans-serif; font-size: 17px; font-weight: 800; letter-spacing: -0.3px; }

        .auth-heading { font-family: 'Syne', sans-serif; font-size: 28px; font-weight: 800; letter-spacing: -0.5px; line-height: 1.2; margin-bottom: 6px; }
        ...
        .strength-bar { display: flex; gap: 4px; margin-top: 7px; align-items: center; }
        .strength-seg { height: 3px; flex: 1; border-radius: 3px; background: rgba(255,255,255,0.07); transition: background 0.3s; }
        .strength-label { font-size: 11px; margin-left: 6px; font-weight: 500; min-width: 36px; transition: color 0.3s; }
      ...
      <div className="auth-root">
        <div className="auth-card">
          ...
          <p className="auth-sub">Join and start exploring with AI</p>
          ...
          <form onSubmit={submitForm}>
            <div className="field">
              ...
              <input className="field-input" type="text" value={username}
                onChange={e => setUsername(e.target.value)} placeholder="choose a username" required autoComplete="username"/>
            </div>
            <div className="field">
